...
namespace MyLearningStrategyMobleXForms.Views
{
    ...
    public partial class CategoriesListPage : ContentPage
    {
        ...
        public CategoriesListPage()
        {
            InitializeComponent();
            Title = "Categories";
            BindingContext = viewModel = new CategoriesListViewModel(App.CurrenUserProfile.Originator, UserDialogs.Instance);
        }
        ...
        //        //    new CategoriesDTO { BodyOfKnowledgeId = viewModel.BodyOfKnowledgeId })));
